...
Now we have all the building blocks, and it's time to actually build something! Here, we will build a simple linear regression model (if you're not used to linear regression, I encourage you to read [this blog post]({{ site.baseurl }}/2025/08/06/linear-regression.html)):
```python
# Import libraries
import torch
