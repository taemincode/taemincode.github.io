...
layout: post
title: "PyTorch"
description: "Learn PyTorch fundamentals from tensors and autograd to a full linear regression example so you can start building deep learning models fast."
date: 2025-09-21
last_modified_at: 2025-10-17
categories: ML
thumbnail: /assets/images/posts/2025/pytorch/thumbnail.webp
image: /assets/images/posts/2025/pytorch/thumbnail.webp
inspired_by: Piet Mondrian
---
{% include responsive-image.html
    src="/assets/images/posts/2025/pytorch/pytorch_logo.webp"
    alt="PyTorch logomark with an orange flame icon"
%}
...
Now we have all the building blocks, and it's time to actually build something! Here, we will build a simple linear regression model (if you're not used to linear regression, I encourage you to read [this blog post]({{ site.baseurl }}/ml/2025/08/06/linear-regression.html)):
```python
# Import libraries
import torch
...
If you'd like to learn more about PyTorch, the [PyTorch Documentation](https://docs.pytorch.org/docs/stable/index.html) is a great place to start with. It would guide you from installaion to all the main components of PyTorch.
...
<div>
The code in this blog post was inspired by <a href="https://www.youtube.com/watch?v=OIenNRt2bjg">AssemblyAI's PyTorch Crash Course</a>  on Youtube.
</div>
</details>